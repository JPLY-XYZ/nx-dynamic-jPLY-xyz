    ...
    return (
        <section className="min-h-screen max-w-[1024px] mx-auto px-10 py-10">
            ...
            <div className="flex flex-col gap-10 items-center mt-20 p-10 bg-blue-100 rounded-xl">
                ...
                <p className="text-2xl place-self-center text-slate-400">{producto.domicilio}</p>
                <p className="text-7xl place-self-center text-blue-400 *:font-bold">{producto.fechanac.toLocaleString().split(',')[0]}</p>
            </div>
        </section>
    );
}
